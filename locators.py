...
class Locators:
    ...
    locator_popup_ingredient_details = (By.XPATH, '//div[@class="Modal_modal__contentBox__sCy8X pt-10 pb-15"]/parent::section')
    ...
    locator_order_element = (By.XPATH, "//ul[@class='OrderFeed_list__OLh59']/child::li[1]/child::a")
    locator_popup_order_details = (By.XPATH, '//p[@class="text text_type_main-medium mb-8"]/parent::div/parent::div/parent::section')
    locator_section_popup_ingredient_details = (By.XPATH, '//ul[@class="Modal_modal__statsList__6cEm5"]/parent::div/parent::div/parent::section')
